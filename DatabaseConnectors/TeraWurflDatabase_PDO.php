...
class TeraWurflDatabase_MySQL5 extends TeraWurflDatabase{
  ...
  PRIMARY KEY (`id`)
	...
	public function connect(){
		$this->numQueries++;
		try{
			// DB_HOST is the complete DSN, like 'mysql:host=localhost;dbname=test'
			$this->dbcon = new PDO(TeraWurflConfig::$DB_HOST, TeraWurflConfig::$DB_USER, TeraWurflConfig::$DB_PASS, self::CONNECTION_OPTIONS);
